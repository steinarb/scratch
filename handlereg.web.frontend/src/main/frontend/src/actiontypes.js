...
export const REST_API_FEILER_FORDI_IKKE_INNLOGGET = createAction('REST_API_FEILER_FORDI_IKKE_INNLOGGET');
export const REST_API_FEILER_FORDI_MANGLENDE_TILGANG = createAction('REST_API_FEILER_FORDI_MANGLENDE_TILGANG');
