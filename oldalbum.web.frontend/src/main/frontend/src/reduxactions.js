...
export const BATCH_ADD_PICTURES_FROM_URL = createAction('BATCH_ADD_PICTURES_FROM_URL');
export const RECEIVE_INDEX_HTML_OF_PICTURE_DIRECTORY = createAction('RECEIVE_INDEX_HTML_OF_PICTURE_DIRECTORY');
