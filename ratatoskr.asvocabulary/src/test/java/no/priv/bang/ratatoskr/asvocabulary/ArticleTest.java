...
class ArticleTest {
    ...
    void testCreate() {
        ...
        assertThat(article.type()).isEqualTo(ActivityStreamObjectType.Article);
        assertThat(article.name()).isEqualTo(name);
        assertThat(article.content()).isEqualTo(content);
        assertThat(article.attributedTo()).isEqualTo(attributedTo);
    }
    ...
    void testCopyAndModify() {
        ...
        var articleCopy = Article.with(article).attributedTo(attributedTo).build();

        assertThat(articleCopy.type()).isEqualTo(ActivityStreamObjectType.Article);
