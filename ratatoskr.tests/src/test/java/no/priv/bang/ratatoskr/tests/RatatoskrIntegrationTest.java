 ...
 * under the License.
 */
package no.priv.bang.ratatoskr.tests;
...
public class RatatoskrIntegrationTest extends KarafTestSupport {
    ...
    public Option[] config() {
        final MavenArtifactUrlReference ratatoskrFeatureRepo = maven()
    ...
    public void testLoadFeature() throws Exception { // NOSONAR this test has an assert, just not an assert sonar recognizes
        installAndAssertFeature("ratatoskr-with-derby");
    }
