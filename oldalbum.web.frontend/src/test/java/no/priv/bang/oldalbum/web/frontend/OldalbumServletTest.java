...
class OldalbumServletTest {
    ...
    void testGetAlbum() throws Exception {
        ...
        when(oldalbum.getPreviousAlbumEntry(anyInt(), anyBoolean())).thenReturn(of(prevEntry));
        ...
        when(oldalbum.getNextAlbumEntry(anyInt(), anyBoolean())).thenReturn(of(nextEntry));
