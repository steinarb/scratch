...
const albumentryParentReducer = createReducer(initialState, {
    [FILL_MODIFY_ALBUM_FORM]: (state, action) => JSON.stringify(action.payload.parent),
    [FILL_ADD_ALBUM_FORM]: (state, action) => action.payload.parent,
    [FILL_MODIFY_PICTURE_FORM]: (state, action) => JSON.stringify(action.payload.parent),
    [FILL_ADD_PICTURE_FORM]: (state, action) => action.payload.parent,
    [MODIFY_ALBUM_PARENT_SELECTED]: (state, action) => JSON.stringify(action.payload),
    [MODIFY_PICTURE_PARENT_SELECTED]: (state, action) => JSON.stringify(action.payload),
