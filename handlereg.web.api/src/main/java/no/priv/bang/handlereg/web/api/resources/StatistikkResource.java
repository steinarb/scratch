...
public class StatistikkResource {
    ...
    public List<ButikkSum> sumOverButikk() {
        return handlereg.sumOverButikk();
    }

    @GET
    @Path("handlingerbutikk")
    public List<ButikkCount> antallHandlingerIButikk() {
        return handlereg.antallHandlingerIButikk();
    }

    @GET
    @Path("sistehandel")
    public List<ButikkDate> sisteHandelIButikk() {
        return handlereg.sisteHandelIButikk();
    }

    @GET
    @Path("sumyear")
    public List<SumYear> totaltHandlebelopPrAar() {
        return handlereg.totaltHandlebelopPrAar();
    }

    @GET
    @Path("sumyearmonth")
    public List<SumYearMonth> totaltHandlebelopPrAarOgMaaned() {
        return handlereg.totaltHandlebelopPrAarOgMaaned();
    }
