...
import no.priv.bang.handlelapp.db.liquibase.production.HandlelapProductionDbLiquibaseRunner;
import no.priv.bang.osgi.service.mocks.logservice.MockLogService;

class HandlelappProductionDbLiquibaseRunnerTest {
    ...
    void testCreateAndVerifySomeDataInSomeTables() throws Exception {
        ...
        HandlelapProductionDbLiquibaseRunner runner = new HandlelapProductionDbLiquibaseRunner();
